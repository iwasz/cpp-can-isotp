 ...
 */
template <> class CanMessageWrapperBase<can_frame> {
public:
        CanMessageWrapperBase () = default;
        explicit CanMessageWrapperBase (can_frame const &cf) : frame (cf) {} /// Construct from underlying implementation type.
